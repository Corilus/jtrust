...
public class OcspTrustLinkerTest {
	...
	public void noOcspUriInCertificate() throws Exception {
		...
		final OcspTrustLinker ocspTrustLinker = new OcspTrustLinker(mockOcspRepository);

		EasyMock.replay(mockOcspRepository);

		final TrustLinkerResult result = ocspTrustLinker.hasTrustLink(certificate, rootCertificate, null,
	...
	public void noOcspResponseInRepository() throws Exception {
		...
		final KeyPair keyPair = PKITestUtils.generateKeyPair();
		final X509Certificate certificate = PKITestUtils.generateCertificate(keyPair.getPublic(), "CN=Test", notBefore,
				notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, "ocsp-uri");
	...
	public void validOcspResponse() throws Exception {
		...
		final OCSPResp ocspResp = PKITestUtils.createOcspResp(certificate, false, rootCertificate, rootCertificate,
		...
		// operate
		final TrustLinkerResult result = ocspTrustLinker.hasTrustLink(certificate, rootCertificate, validationDate,
				new RevocationData(), new DefaultAlgorithmPolicy());
	...
	public void ocspResponseMD5Signature() throws Exception {
		...
		final KeyPair keyPair = PKITestUtils.generateKeyPair();
		final X509Certificate certificate = PKITestUtils.generateCertificate(keyPair.getPublic(), "CN=Test", notBefore,
				notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, "ocsp-uri", null, "MD5withRSA");

		final OCSPResp ocspResp = PKITestUtils.createOcspResp(certificate, false, rootCertificate, rootCertificate,
				rootKeyPair.getPrivate(), "MD5WITHRSA");
	...
	public void wrongOcspResponse() throws Exception {
		...
		final X509Certificate certificate2 = PKITestUtils.generateCertificate(keyPair.getPublic(), "CN=Test2", notBefore,
				notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, "ocsp-uri");

		final OCSPResp ocspResp2 = PKITestUtils.createOcspResp(certificate2, false, rootCertificate, rootCertificate,
				rootKeyPair.getPrivate());
	...
	public void revokedOcsp() throws Exception {
		...
		final OCSPResp ocspResp = PKITestUtils.createOcspResp(certificate, true, rootCertificate, rootCertificate,
				rootKeyPair.getPrivate());
	...
	public void validDedicatedAuthorizedOcspResponse() throws Exception {
		...
		final KeyPair ocspResponderKeyPair = PKITestUtils.generateKeyPair();
		final X509Certificate ocspResponderCertificate = PKITestUtils.generateCertificate(ocspResponderKeyPair.getPublic(),
				"CN=OCSPResp", notBefore, notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, null,
				null, "SHA1withRSA", false, false, false, null, null, null, true);

		final KeyPair keyPair = PKITestUtils.generateKeyPair();
		final X509Certificate certificate = PKITestUtils.generateCertificate(keyPair.getPublic(), "CN=Test", notBefore,
				notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, "ocsp-uri");

		final OCSPResp ocspResp = PKITestUtils.createOcspResp(certificate, false, rootCertificate, ocspResponderCertificate,
				ocspResponderKeyPair.getPrivate());
	...
	public void rootCAIssuesOcspResponseRootCACertInResponse() throws Exception {
		...
		final OCSPResp ocspResp = PKITestUtils.createOcspResp(certificate, false, rootCertificate, rootCertificate,
				rootKeyPair.getPrivate(), "SHA1withRSA", Collections.singletonList(rootCertificate));
	...
	public void invalidDedicatedAuthorizedOcspResponse() throws Exception {
		...
		final X509Certificate ocspResponderCertificate = PKITestUtils.generateCertificate(ocspResponderKeyPair.getPublic(),
				"CN=OCSPResp", notBefore, notAfter, rootCertificate, rootKeyPair.getPrivate(), false, -1, null, null,
				null, "SHA1withRSA", false, false, false, null, null, null, false);
